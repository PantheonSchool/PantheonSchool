            ...
            <Modal.Body className='pt-3'>
                ...
                <div className="d-flex flex-column w-100">
                    ...
                    <div style={{ fontSize: '0.675rem', letterSpacing: '0.075em', gap: '5px' }} className="py-3 py-md-0 h-100 w-100 d-flex flex-column justify-content-between justify-content-md-end px-md-5">
                        ...
                        <Link onClick={handleClose} className="text-light px-3 d-flex flex-row" to='/contact-us'><BsTelephone style={{ fontSize: '15px' }} className='align-top text-mustard me-2' /><span>CONTACT US</span></Link>
