            ...
            <div className='d-flex'>
                ...
                <div className='content px-4' style={{ paddingTop: navHeight }}>
                    <div className='col-lg-11'>
                        ...
                        <p>
                            <p className='fst-italic'>“The aim of education is the knowledge, not of facts, but of values.”</p>
                            ...
                            <p className='fst-italic'>“Let noble thoughts come to us from every side”</p>
